...
<section style="margin-top: 20px;">
              <div class="container">
                ...
                <h6>Modified date: April 19, 2021</h6>
                <br>
                <p class="lead">ARSOME LLC, and ("us", "we", or "our") operates mobile applications (the "Service").
</p>
<p class="lead">
...
<p class="lead">ARSOME LLC uses the
...
<p class="lead">ARSOME LLC will retain your
...
<p class="lead">ARSOME LLC will also retain
...
<p class="lead">ARSOME LLC will take all steps
...
<p class="lead">Under certain circumstances, ARSOME LLC may be required to disclose your Personal Data if required
...
<p class="lead">ARSOME LLC may disclose your
...
<br>
<p class="lead">ARSOME LLC aims to take reasonable
...
<a href="mailto:info@arsome.com" style="text-decoration: none; color: #2f94f9;">info@arsome.com</a></p>
