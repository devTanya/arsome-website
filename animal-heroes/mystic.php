 ...
 <div class="nav-item">
          ...
          <div class="overflow-hidden text-center bg-light hero" style="margin-top: -115px;">
            ...
            <div class="row">
                <div class="col">
                  <br><br><br><br><br><br>
                    <h1 class="hero-text" style="text-shadow: 0px 0px 0px black, 0 0 30px black, 0 0 0px black, 0 0 0px black; font-size: 2.5rem;">Looking for a fun, immersive, educational experience for kids?</h1>
                    <p class="lead hero-desc" style="font-weight: 500; text-shadow: #000000 2px 0 20px;">Take the plunge and learn about the wild creatures of the ocean with fun, educational experiences.</p>
                    <a href="#" class="btn btn-danger btn-md btn-hero">Take the plunge</a>
                    <br><br><br>
                </div>
                <div class="col">
          ...
          <div id="mobile-content">
            <div class="overflow-hidden text-center bg-light hero-mobile" style="margin-top: -100px;">
                <div class="container">
                  <h1 class="hero-text">Looking for a fun, immersive, educational experience for kids?</h1>
                  <p class="lead hero-desc" style="font-weight: 300;">Take the plunge and learn about the wild creatures of the ocean with fun, educational experiences.</p>
                  <a href="#" class="btn btn-danger btn-md btn-hero">Take the plunge</a>
                  <br><br>
              </div></div>
            </div>
          ...
          <div id="desktop-content">
          <section style=" background-image: url('./girl.jpg'); background-position: center center; 
          background-repeat: no-repeat;
              ...
              <div class="container" >
                  <div class="row">
                      <div class="col-md-8" style="margin-top: 200px;">
                          <br>
                          <h1 style=" color: #fff; font-weight: bold;">Immersive, Educational, Fun.</h1>
                          <p class="lead" style="font-size: 20px; color: #fff; width: 80%;">
...
"Super fun games! I love being Tom the Marine Biologist and learning all about the animals."
 ...
 <!--           </div>-->
            ...
            <div id="mobile-content">
              <svg style="z-index: 9999; position: relative; margin-top: -90px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#2e85e6" fill-opacity="1" d="M0,224L80,218.7C160,213,320,203,480,208C640,213,800,235,960,234.7C1120,235,1280,213,1360,202.7L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
              </div>

  <div id="desktop-content" style="margin-top: -110px;">
            <section class="pricing py-5" style="margin-top: -30px; background-color: #2e85e6; z-index: 99; position: relative;">
              <div class="container">

                <center><h1 style="color: white; font-weight: 600; margin-top: 165px;">Subscriptions</h1></center>
            ...
            <br>
               ...
               <div class="col" style="z-index: 9999; position: relative;">
...
<div id="most-popular" style="background-color: transparent; border-radius: 16px;">
              ...
              <div class="col" style="z-index: 9999; position: relative;">
                ...
                <div class="card " style="width: 100%; background-color: #fff; margin-top: 30px; ">
                  <div class="card-body">
                    ...
                    <h6 class="card-price text-center" style="color: black;">14.95<span class="period" style="color: black;">/month</span></h6>
                    <!--<center><small class="text-muted" style="font-weight: bold;">$167.70 /total</small></center>-->
                    <hr>
                    <ul class="fa-ul" class="text-align: center; width: 200px;">
                      <li style="color: black;"><span class="fa-li"><i class="fas fa-times"></i></span>Monthly Box</li>
                                      <li><span class="fa-li"><i class="fas fa-check"></i></span>Digital Content</li>
          ...
          <div id="desktop-content">
          <section style="background-color: #0C56A6; margin-top: -40px; z-index: 999; position: relative;">

           
            <div class="container">
              <br><br>
              <div class="row">
                  <center><img src="http://d9hhrg4mnvzow.cloudfront.net/unbouncepages.com/animal-heroes-mystic-aquarium-audience/d3a3277e-logo-white_1000000000000000000028.png" height="65"></center>
              <center><h1 style="margin-top: 25px; color: #fff; width: 75%;">How Animal Heroes Helps Mystic Aquarium</h1></center>
              <center><p class="lead" style="color: #fff; width: 75%; text-align: center;">Your purchase of an Animal Heroes subscription provides countless benefits to your family and supports Mystic Aquarium’s mission to protect our ocean planet.</p></center>
              </div>
                <center>
                  <br>
                    ...
                    <img src="./mystic.png" style="width: 100%;">

                </center>
                <br>
            </div>
<br>
<center>                  <a href="https://parents.mysticanimalheroes.org/register" class="btn btn-danger btn-md" style="font-weight: bold; margin-top: -5px; font-size: 18px; padding-top: 7px; padding-bottom: 7px; padding-left: 20px; padding-right: 20px;">Get Started</a>
</center><br><br><br><br>
             ...
             <!--<div id="desktop-content">-->
             <!-- <svg style="z-index: 999; position: relative; margin-top: -260px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#e6f4ff" fill-opacity="1" d="M0,224L80,218.7C160,213,320,203,480,208C640,213,800,235,960,234.7C1120,235,1280,213,1360,202.7L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>-->
             <!-- </div>-->
   
<div id="desktop-content">
          <section style="position: relative; background: linear-gradient(0deg, rgba(34,105,184,1) 0%, rgba(43,129,224,1) 30%, rgba(230,244,254,1) 60%, rgba(230,244,254,1) 100%); margin-top: -40px; background-position: bottom center; z-index: 9;">
              <div class="container">
                <br><br><br><br><br>  <br><br>
                  <div class="row" style="margin-top: 30px;">
                      ...
                      <div class="col">
                        ...
                        <center>
                            ...
                            <img src="img/shipped.png" class="animated fadeInDown" height="280" style="margin-top: -102px; z-index: 9999; position: relative;"> <br> <h1 style="color: white; margin-top: 15px; font-size: 2.5rem;">Step 2</h1>
...
<!--</div>-->
          ...
          <div id="mobile-content">
            <section style="background-color: #0C56A6; margin-top: -50px;">
              <br><br>
              <div class="container">
...
<br><br><br>
                ...
                <p class="lead" style="color: #fff; width: 95%;">Your purchase of an Animal Heroes subscription provides countless benefits to your family and supports Mystic Aquarium’s mission to protect our ocean planet.</p></center>
                  <center>
                    <br>
...
width="24" height="24"
viewBox="0 0 172 172"
style=" fill:#083462;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#525b55"><path d="M129.50883,86l-39.9255,39.9255l10.75,10.75l50.6755,-50.6755l-50.6755,-50.6755l-10.75,10.75z"></path><path d="M136.16667,93.16667l-114.66667,0v-14.33333l114.66667,0z"></path></g></g></svg></span> A design-your-own avatar
...
width="24" height="24"
viewBox="0 0 172 172"
style=" fill:#083462;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#525b55"><path d="M129.50883,86l-39.9255,39.9255l10.75,10.75l50.6755,-50.6755l-50.6755,-50.6755l-10.75,10.75z"></path><path d="M136.16667,93.16667l-114.66667,0v-14.33333l114.66667,0z"></path></g></g></svg></span> Videos about animals and experts
...
width="24" height="24"
viewBox="0 0 172 172"
style=" fill:#083462;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#525b55"><path d="M129.50883,86l-39.9255,39.9255l10.75,10.75l50.6755,-50.6755l-50.6755,-50.6755l-10.75,10.75z"></path><path d="M136.16667,93.16667l-114.66667,0v-14.33333l114.66667,0z"></path></g></g></svg></span> Access to the community
