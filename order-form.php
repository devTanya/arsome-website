	<!DOCTYPE html>
		<html lang="en">
			<head>
				...
				<title>ARSOME Technology: Order Form</title>
				<!-- index description -->
				...
				<link rel="canonical" href="https://arsome.com/order-form" content="https">
				<!-- social description -->
						...
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-md-9 col-lg-8 col-xl-6">
									...
									<form method="post"
		action="https://formbucket.com/f/buk_L6myV4vVe0EfxKQxcDSury6U">
										<div class="row">
											<div class="col-md-6">
