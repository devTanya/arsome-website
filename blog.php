...
<html lang="en">
   <head>
      ...
      <?php require('includes/metas/blog.php') ?>
      <link href="https://arsome.com/blog" rel="canonical"/>
...
<!-- End Facebook Pixel Code -->
   ...
   <body>
      ...
      <noscript><iframe src="https://googletagmanager.com/ns.html?id=GTM-WZFZJ2Z"
         ...
         <div class="container py-0">
            <div class="row my-4 my-md-6 text-center justify-content-center align-items-center">
               <div class="col-lg-9 col-xl-8">
                  <br>
                  <h1 style="color: #000; font-size: 3.5rem;"><b>Blog</b></h1>
               </div>
            </div>
         </div>
         <div class="divider">
               ...
               <div class="col layer-1">
                  <a href="/blogs/3-Ways-Museums-Can-Benefit-From-AR-Usage" class="card card-article-wide flex-md-row no-gutters hover-shadow-3d">
                     ...
                     <div class="card-body d-flex flex-column justify-content-between col-auto p-4 p-lg-5">
                        <div>
                           <div class="h3" style="color: black;"><b>3 Ways Museums Can Benefit From AR Usage
</b></div>
...
<span style="font-weight:bold;"> 06-12-2020</span>                        <br><br>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                     ...
                     <div class="card-body align-items-start">
                        ...
                        <br> 
                       <span style="font-weight:bold;"> 02-14-2020</span>
                        <br><br>
                        <a href="/blogs/ar-vr-and-fiveg">
                          <span class="btn-pri-link">Read Article →</span>
                        </a>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                     <a href="/blogs/ar-in-the-classroom"> <img src="https://images.unsplash.com/photo-1504375243548-4c974e20e993?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" alt="Image" style="height: 30vh;" class="card-img-top"> </a> 
                     <div class="card-body align-items-start">
                       
                        <h3 style="font-weight: bold; color: black; text-decoration: underline; text-decoration-color: #7ebbf7;"> <b>Augmented Reality in the Classroom</b></h3>
                        
                        <p style="font-size: 16px; color: #555;">
                           Traditional learning tools, like textbooks, may be old news with augmented reality on the rise...
                        ...
                        <br> 
                       <span style="font-weight:bold;"> 10-15-2019</span>
                        <br><br>
                        <a href="/blogs/ar-in-the-classroom">
                           <span class="btn-pri-link">Read Article →</span>
                        </a>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                     <a href="/blogs/moving-beyond-the-wow-factor"> <img src="https://images.unsplash.com/photo-1548125119-57853b9b0f07?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Image" class="card-img-top" style="height: 30vh;"> </a> 
                     <div class="card-body align-items-start">
                        ...
                        <br> 
                        <span style="font-weight:bold;"> 08-17-2019</span>
                        <br><br>
                        <a href="/blogs/moving-beyond-the-wow-factor">
                           <span class="btn-pri-link">Read Article →</span>
                        </a>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                     <a href="/blogs/ar-in-media-and-print"> <img src="https://images.unsplash.com/photo-1573152143286-0c422b4d2175?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" alt="Image" style="height: 30vh;" class="card-img-top"> </a> 
                     <div class="card-body align-items-start">
                        ...
                        <br> 
                        <span style="font-weight:bold;"> 08-09-2019</span>
                        <br><br>
                        <a href="/blogs/ar-in-media-and-print">
                           <span class="btn-pri-link">Read Article →</span>
                        </a>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                    <a href="/blogs/gamification"> <img src="https://images.unsplash.com/photo-1554474051-0256b98c36f8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="Image" class="card-img-top" style="height: 30vh;"> </a> 
                     <div class="card-body align-items-start">
                        ...
                        <br>
                        <span style="font-weight:bold;"> 07-02-2019</span>
                        <br>
                        <br>
                        <a href="/blogs/gamification">
                           <span class="btn-pri-link">Read Article →</span>
                        </a> 
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-lg-4">
                  <div class="card">
                     <a href="/blogs/ar-vr-in-the-workplace"> <img src="https://images.unsplash.com/photo-1495510096779-5fbe73258c83?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1349&q=80" alt="Image" style="height: 30vh;" class="card-img-top"> </a> 
                     <div class="card-body align-items-start">
                        ...
                        <br> 
                      <span style="font-weight:bold;"> 06-24-2019</span>
                        <br><br>
                        <a href="/blogs/ar-vr-in-the-workplace">
                          <span class="btn-pri-link">Read Article →</span>
                        </a>
                     </div>
                  </div>
